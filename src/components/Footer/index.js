...
export default function Footer() {
    return (
        <>
            ...
            {/* <div className="footer__two all-footer bg-dark text-light pt-5">
                <div className="containe pt-30" style={{ fontSize: '17px' }}>
    ...
    <div className="container pt-30" style={{ fontSize: '17px' }}>
        <div className="row d-flex justify-content-around align-items-start flex-wrap" style={{ gap: '30px' }}>
            ...
            <div className="col-xl-2 col-lg-3 col-md-6">
                <div className="footer__two-widget footer-border">
                    ...
                    <div className="footer__two-widget-location">
                        <div className="footer__two-widget-location-item-info pb-2">
                            <Link to='/services' className='link' >- Cloud services</Link>
                        </div>
                        <div className="footer__two-widget-location-item-info pb-2">
                            <Link to='/services/cyberSecurity' className='link' >- Cyber Security</Link>
                        </div>
                        <div className="footer__two-widget-location-item-info pb-2">
                            <Link to='/services/cloudMigration' className='link' >- Cloud migration</Link>
                        </div>
                        <div className="footer__two-widget-location-item-info pb-2">
                            <Link to='/services/softwareDevelopment' className='link' >- Software development</Link>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="footer__two-widget-location">
                        ...
                        <div className="footer__two-widget-about-social">
                            <ul style={{ display: 'flex', gap: '3px', listStyle: 'none', marginTop: '19px' }}>
                                ...
                                <li>
                                    <Link to='https://www.instagram.com/' target='blank'>
                                        <i className='social fab fa-instagram'
                                            style={{
                                                borderRadius: '23px', padding: '15px', boxShadow: '0px 10px 20px rgba(0, 0, 0, 0.15)'
                                            }} />
                                    </Link>
